...
<div class="panel panel-white">
	<div class="panel-heading">
		<h4 class="panel-title"><span class="btn btn-sm btn-transparent-grey locationlinkfinal backbutton no-display" id="backbutton"><i class="fa fa-angle-double-left"> </i></span> <?php echo $this->translate('TXT_SELECTION_PANEL');?></h4>
	</div>
	<div class="panel-tools forwardregisterbutton no-display visible-sm" style="opacity:1" id="forwardregisterbutton">
		<div class="dropdown">
