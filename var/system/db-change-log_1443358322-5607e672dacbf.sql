...
ALTER TABLE `object_query_17` DROP INDEX `p_index_action`;

/*--NEXT--*/

ALTER TABLE `object_store_17` DROP INDEX `p_index_action`;

/*--NEXT--*/

ALTER TABLE `object_query_17` DROP INDEX `p_index_communication`;

/*--NEXT--*/

ALTER TABLE `object_store_17` DROP INDEX `p_index_communication`;

/*--NEXT--*/

ALTER TABLE `object_query_17` DROP INDEX `p_index_message`;

/*--NEXT--*/

ALTER TABLE `object_store_17` DROP INDEX `p_index_message`;

/*--NEXT--*/

ALTER TABLE `object_query_17` DROP INDEX `p_index_partysize`;

/*--NEXT--*/

ALTER TABLE `object_store_17` DROP INDEX `p_index_partysize`;

/*--NEXT--*/

ALTER TABLE `object_query_17` ADD COLUMN `start` bigint(20) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_17` ADD COLUMN `start` bigint(20) NULL;

/*--NEXT--*/

ALTER TABLE `object_query_17` DROP INDEX `p_index_start`;

/*--NEXT--*/

ALTER TABLE `object_store_17` DROP INDEX `p_index_start`;
