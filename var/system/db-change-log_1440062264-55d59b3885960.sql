...
ALTER TABLE `object_query_9` ADD COLUMN `url__id` int(11) NULL;

/*--NEXT--*/

ALTER TABLE `object_query_9` ADD COLUMN `url__type` enum('document','asset','object') NULL;

/*--NEXT--*/

ALTER TABLE `object_query_9` DROP INDEX `p_index_url__id`;

/*--NEXT--*/

ALTER TABLE `object_query_9` DROP INDEX `p_index_url__type`;

/*--NEXT--*/

ALTER TABLE `object_store_9` DROP INDEX `p_index_url__id`;

/*--NEXT--*/

ALTER TABLE `object_store_9` DROP INDEX `p_index_url__type`;

/*--NEXT--*/

ALTER TABLE `object_query_9` DROP COLUMN `url`;

/*--NEXT--*/

ALTER TABLE `object_store_9` DROP COLUMN `url`;
