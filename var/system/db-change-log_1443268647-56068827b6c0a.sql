...
ALTER TABLE `object_query_16` ADD COLUMN `timechange` bigint(20) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_16` ADD COLUMN `timechange` bigint(20) NULL;
