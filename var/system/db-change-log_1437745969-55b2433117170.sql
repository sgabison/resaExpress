...
ALTER TABLE `object_query_11` CHANGE COLUMN `arrived` `arrived` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_11` CHANGE COLUMN `arrived` `arrived` varchar(255) NULL;
