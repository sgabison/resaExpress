...
ALTER TABLE `object_query_14` ADD COLUMN `shortname` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_14` ADD COLUMN `shortname` varchar(255) NULL;
...
ALTER TABLE `object_query_14` ADD COLUMN `longname` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_14` ADD COLUMN `longname` varchar(255) NULL;
...
ALTER TABLE `object_query_14` ADD COLUMN `start` bigint(20) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_14` ADD COLUMN `start` bigint(20) NULL;
...
ALTER TABLE `object_query_14` ADD COLUMN `end` bigint(20) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_14` ADD COLUMN `end` bigint(20) NULL;
