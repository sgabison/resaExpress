...
ALTER TABLE `object_query_12` CHANGE COLUMN `bookingnotes` `bookingnotes` longtext NULL;

/*--NEXT--*/

ALTER TABLE `object_store_12` CHANGE COLUMN `bookingnotes` `bookingnotes` longtext NULL;
