...
ALTER TABLE `object_query_11` ADD COLUMN `actualpartysize` double NULL;

/*--NEXT--*/

ALTER TABLE `object_store_11` ADD COLUMN `actualpartysize` double NULL;
