...
ALTER TABLE `object_query_17` ADD COLUMN `action` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_17` ADD COLUMN `action` varchar(255) NULL;
