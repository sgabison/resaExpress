...
ALTER TABLE `object_query_11` CHANGE COLUMN `arrived` `arrived` double NULL;

/*--NEXT--*/

ALTER TABLE `object_store_11` CHANGE COLUMN `arrived` `arrived` double NULL;
