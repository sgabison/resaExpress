...
ALTER TABLE `object_query_15` ADD COLUMN `code` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_15` ADD COLUMN `code` varchar(255) NULL;
...
ALTER TABLE `object_localized_data_15` ADD COLUMN `tag` varchar(255) NULL;
...
ALTER TABLE `object_localized_query_15_en` ADD COLUMN `tag` varchar(255) NULL;
...
ALTER TABLE `object_localized_query_15_fr_FR` ADD COLUMN `tag` varchar(255) NULL;
...
SELECT `oo_id`,`oo_classId`,`oo_className`,`code`,`o_id`,`o_parentId`,`o_type`,`o_key`,`o_path`,`o_index`,`o_published`,`o_creationDate`,`o_modificationDate`,`o_userOwner`,`o_userModification`,`o_classId`,`o_className`,`en`.`ooo_id` as "ooo_id",`en`.`language` as "language",`en`.`tag` as "tag"
...
SELECT `oo_id`,`oo_classId`,`oo_className`,`code`,`o_id`,`o_parentId`,`o_type`,`o_key`,`o_path`,`o_index`,`o_published`,`o_creationDate`,`o_modificationDate`,`o_userOwner`,`o_userModification`,`o_classId`,`o_className`,`fr_FR`.`ooo_id` as "ooo_id",`fr_FR`.`language` as "language",`fr_FR`.`tag` as "tag"
FROM `object_query_15`
    JOIN `objects`
