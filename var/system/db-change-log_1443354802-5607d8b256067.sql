...
ALTER TABLE `object_query_16` CHANGE COLUMN `message` `message` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_16` CHANGE COLUMN `message` `message` varchar(255) NULL;
