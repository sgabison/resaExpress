...
ALTER TABLE `object_query_16` ADD COLUMN `reservation__id` int(11) NULL;

/*--NEXT--*/

ALTER TABLE `object_query_16` ADD COLUMN `reservation__type` enum('document','asset','object') NULL;
