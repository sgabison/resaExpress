...
ALTER TABLE `object_query_14` ADD COLUMN `societe__id` int(11) NULL;

/*--NEXT--*/

ALTER TABLE `object_query_14` ADD COLUMN `societe__type` enum('document','asset','object') NULL;

/*--NEXT--*/

ALTER TABLE `object_query_14` DROP INDEX `p_index_societe__id`;

/*--NEXT--*/

ALTER TABLE `object_query_14` DROP INDEX `p_index_societe__type`;

/*--NEXT--*/

ALTER TABLE `object_store_14` DROP INDEX `p_index_societe__id`;

/*--NEXT--*/

ALTER TABLE `object_store_14` DROP INDEX `p_index_societe__type`;
...
ALTER TABLE `object_query_14` DROP COLUMN `societe`;
