UPDATE `classes` SET `id` = 4, `name` = 'person', `description` = '', `creationDate` = 1368620452, `modificationDate` = 1443690874, `userOwner` = 0, `userModification` = 35, `parentClass` = 'Website\\Object\\Person', `useTraits` = '', `allowInherit` = 0, `allowVariants` = 0, `showVariants` = 0, `icon` = '', `previewUrl` = '', `propertyVisibility` = 'a:2:{s:4:\"grid\";a:5:{s:2:\"id\";b:1;s:4:\"path\";b:1;s:9:\"published\";b:1;s:16:\"modificationDate\";b:1;s:12:\"creationDate\";b:1;}s:6:\"search\";a:5:{s:2:\"id\";b:1;s:4:\"path\";b:1;s:9:\"published\";b:1;s:16:\"modificationDate\";b:1;s:12:\"creationDate\";b:1;}}' WHERE (id = 4);
...
ALTER TABLE `object_query_4` ADD COLUMN `location__id` int(11) NULL;

/*--NEXT--*/

ALTER TABLE `object_query_4` ADD COLUMN `location__type` enum('document','asset','object') NULL;

/*--NEXT--*/

ALTER TABLE `object_query_4` DROP INDEX `p_index_location__id`;

/*--NEXT--*/

ALTER TABLE `object_query_4` DROP INDEX `p_index_location__type`;

/*--NEXT--*/

ALTER TABLE `object_store_4` DROP INDEX `p_index_location__id`;

/*--NEXT--*/

ALTER TABLE `object_store_4` DROP INDEX `p_index_location__type`;
