...
ALTER TABLE `object_query_12` ADD COLUMN `bookingnotes` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_12` ADD COLUMN `bookingnotes` varchar(255) NULL;
