UPDATE `classes` SET `id` = 8, `name` = 'societe', `description` = '', `creationDate` = 1433166188, `modificationDate` = 1441349917, `userOwner` = 30, `userModification` = 35, `parentClass` = 'Website\\Object\\Societe', `useTraits` = '', `allowInherit` = 0, `allowVariants` = 0, `showVariants` = 0, `icon` = '', `previewUrl` = '', `propertyVisibility` = 'a:2:{s:4:\"grid\";a:5:{s:2:\"id\";b:1;s:4:\"path\";b:1;s:9:\"published\";b:1;s:16:\"modificationDate\";b:1;s:12:\"creationDate\";b:1;}s:6:\"search\";a:5:{s:2:\"id\";b:1;s:4:\"path\";b:1;s:9:\"published\";b:1;s:16:\"modificationDate\";b:1;s:12:\"creationDate\";b:1;}}' WHERE (id = 8);
...
ALTER TABLE `object_query_8` CHANGE COLUMN `maxResaSeats` `maxResaSeats` double NULL;

/*--NEXT--*/

ALTER TABLE `object_store_8` CHANGE COLUMN `maxResaSeats` `maxResaSeats` double NULL;
