...
ALTER TABLE `object_query_11` DROP INDEX `p_index_actualpartysize`;

/*--NEXT--*/

ALTER TABLE `object_store_11` DROP INDEX `p_index_actualpartysize`;
...
ALTER TABLE `object_query_11` ADD COLUMN `actualstart` bigint(20) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_11` ADD COLUMN `actualstart` bigint(20) NULL;

/*--NEXT--*/

ALTER TABLE `object_query_11` DROP INDEX `p_index_actualstart`;

/*--NEXT--*/

ALTER TABLE `object_store_11` DROP INDEX `p_index_actualstart`;
