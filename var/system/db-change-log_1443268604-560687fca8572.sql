...
ALTER TABLE `object_query_16` ADD COLUMN `person__id` int(11) NULL;

/*--NEXT--*/

ALTER TABLE `object_query_16` ADD COLUMN `person__type` enum('document','asset','object') NULL;
