...
ALTER TABLE `object_query_16` ADD COLUMN `communication` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_16` ADD COLUMN `communication` varchar(255) NULL;
