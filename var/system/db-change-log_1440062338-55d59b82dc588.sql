...
ALTER TABLE `object_query_9` ADD COLUMN `url` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_9` ADD COLUMN `url` varchar(255) NULL;
...
ALTER TABLE `object_query_9` DROP COLUMN `url__id`;

/*--NEXT--*/

ALTER TABLE `object_query_9` DROP COLUMN `url__type`;
