...
ALTER TABLE `object_query_17` ADD COLUMN `message` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_17` ADD COLUMN `message` varchar(255) NULL;
