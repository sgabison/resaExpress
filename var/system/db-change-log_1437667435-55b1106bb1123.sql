UPDATE `classes` SET `id` = 12, `name` = 'guest', `description` = '', `creationDate` = 1433423698, `modificationDate` = 1437667435, `userOwner` = 35, `userModification` = 30, `parentClass` = 'Website\\Object\\Guest', `useTraits` = '', `allowInherit` = 0, `allowVariants` = 0, `showVariants` = 0, `icon` = '', `previewUrl` = '', `propertyVisibility` = 'a:2:{s:4:\"grid\";a:5:{s:2:\"id\";b:1;s:4:\"path\";b:1;s:9:\"published\";b:1;s:16:\"modificationDate\";b:1;s:12:\"creationDate\";b:1;}s:6:\"search\";a:5:{s:2:\"id\";b:1;s:4:\"path\";b:1;s:9:\"published\";b:1;s:16:\"modificationDate\";b:1;s:12:\"creationDate\";b:1;}}' WHERE (id = 12);
...
ALTER TABLE `object_query_12` ADD COLUMN `firstname` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_12` ADD COLUMN `firstname` varchar(255) NULL;
