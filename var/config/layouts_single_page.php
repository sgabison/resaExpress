...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetsplugins/bootstrap/css/bootstrap.min.css">
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetsplugins/font-awesome/css/font-awesome.min.css">
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetsplugins/iCheck/skins/all.css">
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetsplugins/perfect-scrollbar/src/perfect-scrollbar.css">
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetsplugins/animate.css/animate.min.css">
		<!-- end: MAIN CSS -->
		<!-- start: CSS REQUIRED FOR SUBVIEW CONTENTS -->
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetsplugins/owl-carousel/owl-carousel/owl.carousel.css">
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetsplugins/owl-carousel/owl-carousel/owl.theme.css">
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetsplugins/owl-carousel/owl-carousel/owl.transitions.css">
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetsplugins/summernote/dist/summernote.css">
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetsplugins/fullcalendar/fullcalendar/fullcalendar.css">
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetsplugins/toastr/toastr.min.css">
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetsplugins/bootstrap-select/bootstrap-select.min.css">
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetsplugins/bootstrap-switch/dist/css/bootstrap3/bootstrap-switch.min.css">
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetsplugins/DataTables/media/css/DT_bootstrap.css">
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetsplugins/bootstrap-fileupload/bootstrap-fileupload.min.css">
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetsplugins/bootstrap-daterangepicker/daterangepicker-bs3.css">
		<!-- end: CSS REQUIRED FOR THIS SUBVIEW CONTENTS-->
		<!-- start: CSS REQUIRED FOR THIS PAGE ONLY -->
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetsplugins/bootstrap-social-buttons/bootstrap-social.css">
		<!-- end: CSS REQUIRED FOR THIS PAGE ONLY -->
		<!-- start: CORE CSS -->
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetscss/styles.css">
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetscss/styles-responsive.css">
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetscss/plugins.css">
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetscss/themes/theme-style8.css" type="text/css" id="skin_color">
		<link rel="stylesheet" href="<?= PIMCORE_WEBSITE_LAYOUT?>/assetscss/print.css" type="text/css" media="print"/>
		<!-- end: CORE CSS -->
				...
				<div class="navbar-content">
					...
					<div class="main-navigation left-wrapper transition-left">
						...
						<ul class="main-navigation-menu">
							<li class="start">
								<a href="layouts_single_content_0.html"><i class="fa fa-home"></i> <span class="title"> Dashboard </span><span class="label label-default pull-right ">LABEL</span> </a>
							</li>
							<li>
								<a href="javascript:void(0)"><i class="fa fa-desktop"></i> <span class="title"> Ajax Submenu 1 </span><i class="icon-arrow"></i> </a>
								<ul class="sub-menu">
									<li>
										<a href="layouts_single_content_1.html">
											<span class="title"> Ajax Sample Page 1 </span>
										</a>
									</li>
									<li>
										<a href="layouts_single_content_2.html">
											<span class="title"> Ajax Sample Page 2 </span>
										</a>
									</li>								
									<li>
										<a href="layouts_single_content_3.html">
							...
							<li>
								<a href="javascript:void(0)"><i class="fa fa-cogs"></i> <span class="title"> Ajax Submenu 2 </span><i class="icon-arrow"></i> </a>
								<ul class="sub-menu">
									<li>
										<a href="layouts_single_content_1.html">
											<span class="title"> Ajax Sample Page 1 </span>
							...
							<li>
								<a href="javascript:void(0)"><i class="fa fa-th-large"></i> <span class="title"> Ajax Submenu 3 </span><i class="icon-arrow"></i> </a>
								<ul class="sub-menu">
									<li>
										<a href="layouts_single_content_1.html">
											<span class="title">Ajax Sample Page 1</span>
